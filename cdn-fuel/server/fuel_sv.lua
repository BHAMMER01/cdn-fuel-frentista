...
RegisterNetEvent('cdn-fuel:info', function(type, amount, srcPlayerData, itemdata)
	if Config.FuelDebug then print("cdn-fuel:info", type, amount) end
    local src = source
    local Player
	...
	if Config.FuelDebug then print("Attempting to update item metadata: "..tostring(ItemName).." Old Data: "..json.encode(itemdata)) end
...
CreateThread(function()
	if not Config.FuelDebug then return end
